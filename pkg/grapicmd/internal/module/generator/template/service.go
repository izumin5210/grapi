...
var Service = assets.NewFileSystem(map[string][]string{"/": []string{}, "/api": []string{}, "/api/protos": []string{"{{.Path}}.proto.tmpl"}, "/app": []string{}, "/app/server": []string{"{{.Path}}_server.go.tmpl", "{{.Path}}_server_test.go.tmpl"}}, map[string]*assets.File{
	"/app/server": &assets.File{
		Path:     "/app/server",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1521962616, 1521962616000000000),
		Data:     nil,
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1521918961, 1521918961000000000),
