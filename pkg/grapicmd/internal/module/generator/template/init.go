...
var Init = assets.NewFileSystem(map[string][]string{"/api/protos/type": []string{".keep.tmpl"}, "/": []string{".gitignore.tmpl", "tools.go", "grapi.toml.tmpl"}, "/cmd": []string{}, "/api/protos": []string{".keep.tmpl"}, "/api": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/app": []string{"run.go.tmpl"}, "/app/server": []string{".keep.tmpl"}}, map[string]*assets.File{
	"/app": &assets.File{
		Path:     "/app",
		FileMode: 0x800001ed,
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1553075117, 1553075117585041940),
		Data:     []byte(_Initc051c9ff1a8e446bc9636d3144c2775a7e235322),
	}, "/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1553075117, 1553075117585318041),
		Data:     nil,
