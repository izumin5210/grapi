...
var Init = assets.NewFileSystem(map[string][]string{"/cmd": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/": []string{".gitignore.tmpl", "Gopkg.toml.tmpl", "grapi.toml.tmpl"}, "/api": []string{}, "/api/protos": []string{".keep.tmpl"}, "/app": []string{"run.go.tmpl"}}, map[string]*assets.File{
	"/api": &assets.File{
		Path:     "/api",
		FileMode: 0x800001ed,
		...
		Path:     "/app",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1520151935, 1520151935000000000),
		Data:     nil,
