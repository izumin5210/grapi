...
var Init = assets.NewFileSystem(map[string][]string{"/api/protos": []string{".keep.tmpl"}, "/app": []string{"run.go.tmpl"}, "/cmd": []string{}, "/cmd/server": []string{"run.go.tmpl"}, "/": []string{".gitignore.tmpl", "Gopkg.toml.tmpl", "grapi.toml.tmpl"}, "/api": []string{}}, map[string]*assets.File{
	"/api/protos": &assets.File{
		...
		Path:     "/app",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1519829917, 1519829917000000000),
		Data:     nil,
		...
		Path:     "/cmd/server",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1519830048, 1519830048000000000),
		Data:     nil,
